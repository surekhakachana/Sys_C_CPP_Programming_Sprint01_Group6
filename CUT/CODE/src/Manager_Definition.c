...
void display_manager_menu(void)
{
        ...
        {
        printf("\n------------------Manager Module---------------------\n");
        printf("Press '1' to Register \nPress '2' to Login \nPress '3' to Add the employee\n Press '4' to remove the Employee\n Press '5' to the add project \n Press '6' to maintain a Project status\n Press '7' add a reports\n Press '8' for Display for Employee and Project id details\n Press '9' for Display for Project_Details\nPress '0' to exit\n");
        scanf("%d",&option);
        switch(option)
        {
                case 1:
        ...
        /*      case 4:
                ...
                case 7 :
                        ...
                        break;
                case 8:
                        DisplayEmployeeAndProjectDetails();
                        break;
                case 9:
