...
/************************************************************************
Function Name: EmployeeView
Description: In this function, check the Project Details
Parameters: void
Return Type:int
...
int EmployeeView(void)
{
        printf("check the project details\n");
        DisplayEmployeeAndProjectDetails();
        printf("Employee Checked the Project Details");
        return 0;
}
