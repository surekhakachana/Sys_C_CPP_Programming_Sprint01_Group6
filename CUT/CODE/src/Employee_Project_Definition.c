...
/*Function header
function name: Display Project id and Employee id
parameters:no parameters
return type:void it returns nothing*/


int DisplayEmployeeAndProjectDetails(void)
{
        Employee_Project ep;
        printf("Assinged Projects for Employee\n");
        printf(" Employee id::%d ",ep.Emp_id);
